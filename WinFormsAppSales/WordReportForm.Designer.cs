namespace PresentationLayer
{
    partial class WordReportForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WordReportForm));
            ...
            label_Name.Size = new Size(918, 91);
            label_Name.TabIndex = 14;
            label_Name.Text = "Создание отчета Word";
            ...
            flowLayoutPanel_HomeButtons.Location = new Point(164, 255);
            ...
            flowLayoutPanel_HomeButtons.TabIndex = 13;
            // 
            ...
            button_ViewReport.Text = "Открыть отчет";
            button_ViewReport.UseVisualStyleBackColor = false;
            button_ViewReport.Click += button_ViewWord_Click;
            // 
            // button_return
            // 
            ...
            button_return.Location = new Point(4, 238);
            ...
            Name = "WordReportForm";
            Text = "Отчет Word";
            FormClosing += WordReportForm_FormClosing;
