...
{
    public partial class TxtReportForm : Form
    {
        private DataTable _data;
        private string _reportText;
        private string _nameOfBase;
        private bool _hasReport;
        public TxtReportForm()
        {
            InitializeComponent();
        }
        ...
        private void button_ReporGenegation_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                GenerateTextReport();
                _hasReport = true;
                MessageBox.Show("Отчёт в формате txt успешно сгенерирован");
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Ошибка при генерации txt: {ex.Message}", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void TxtReportForm_FormClosing(object sender, FormClosingEventArgs e)
        {
